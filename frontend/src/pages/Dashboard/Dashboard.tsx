        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button
              ...
              className="h-9 rounded-full border-zinc-200 dark:border-zinc-700/60 bg-transparent px-4 text-sm text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-800/50 hover:text-zinc-900 dark:hover:text-zinc-100"
            >
          ...
          <CardContent className="p-4 grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-4 items-end">
            ...
            <div className="flex flex-col gap-1.5">
              <label
                ...
                className="text-[10px] font-bold tracking-[0.2em] text-zinc-500 dark:text-zinc-400 uppercase"
              >
                Data Inicial
              </label>
              <input
                ...
                className="h-10 rounded-xl border border-zinc-200 dark:border-zinc-700/60 bg-zinc-50 dark:bg-zinc-950/40 px-3 text-sm text-zinc-800 dark:text-zinc-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500/50 dark:[color-scheme:dark]"
              />
            </div>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="h-10 w-full cursor-pointer appearance-none rounded-xl border border-zinc-200 dark:border-zinc-700/60 bg-zinc-50 dark:bg-zinc-950/40 pl-9 pr-4 text-sm text-zinc-800 dark:text-zinc-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500/50 dark:[color-scheme:dark] disabled:opacity-50"
                >
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <select
                ...
                className="h-10 w-full cursor-pointer appearance-none rounded-xl border border-zinc-200 dark:border-zinc-700/60 bg-zinc-50 dark:bg-zinc-950/40 px-3 text-sm text-zinc-800 dark:text-zinc-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500/50 dark:[color-scheme:dark]"
              >
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            {Array.from({ length: 8 }).map((_, i) => (
              <Card
                key={i}
                className="border border-zinc-100 dark:border-zinc-800/60 bg-white dark:bg-zinc-900/30 animate-pulse"
              >
          ...
          /* Empty State */
          <Card className="border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/30">
            <CardContent className="flex flex-col items-center justify-center py-12 text-center gap-4">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-zinc-100 dark:bg-zinc-800 text-zinc-500">
              ...
              <div>
                ...
                <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-1 max-w-sm">
                  Nenhum dado encontrado para o período selecionado. Tente alterar os filtros de
                  data ou filial.
                </p>
              </div>
            </CardContent>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <h2 className="text-xs font-bold tracking-[0.2em] text-zinc-400 dark:text-zinc-500 uppercase">
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                ...
                <Card className="border border-zinc-200 dark:border-zinc-800/60 bg-white dark:bg-zinc-900/30">
                  ...
                  <CardContent className="space-y-2">
                    <div className="text-2xl font-black text-zinc-850 dark:text-zinc-100">
