...
export function PageHeader({ onCancel, step = 1 }: PageHeaderProps) {
  return (
    <div className="flex items-center justify-between px-8 py-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <Button
          type="button"
          className="h-9 rounded-full bg-red-600 px-5 text-sm font-semibold text-white shadow-lg shadow-red-600/25 hover:bg-red-700"
        >
          Salvar Rascunho
        </Button>
      </div>
