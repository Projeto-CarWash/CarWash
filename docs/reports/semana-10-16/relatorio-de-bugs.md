# Relatório de Bugs — Semana 10-16 (10 a 16 de maio)

**Projeto:** CarWash  ·  **Período:** 10 a 16 de maio de 2026  ·  **Gerado em:** 29/05/2026  ·  **Base:** template oficial `relatorio-de-bugs-template.md`
...
**Nenhum bug formalmente registrado nesta semana** (nenhum card entrou na coluna *BUGS* nem recebeu a label *BUG* no período).
 Período correspondente à fase de planejamento/backlog — sem ciclo de teste ativo no quadro.
...
| ID | Título | Módulo | Severidade | Status | Referência |
|---|---|---|---|---|---|
| — | Nenhum bug registrado no período | - | - | - | - |
