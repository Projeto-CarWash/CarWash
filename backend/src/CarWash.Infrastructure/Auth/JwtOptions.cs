...
public sealed class JwtOptions
{
    ...
    /// <summary>
    /// Gets or sets chave de assinatura HMAC-SHA256. ≥ 32 bytes (256 bits). Lida de
    /// <c>CARWASH_JWT_SECRET</c> via binding — nunca commitada.
    /// </summary>
    public string Secret { get; set; } = string.Empty;

    /// <summary>
    /// Gets or sets chave HMAC-SHA256 dedicada à assinatura do <c>tokenConfirmacao</c> da
    ...
    /// <summary>Gets or sets validade do access token JWT em segundos. Default 900s = 15min.</summary>
    public int AccessTokenValiditySeconds { get; set; } = 900;

    /// <summary>Gets or sets validade do refresh token em segundos. Default 604800s = 7 dias.</summary>
