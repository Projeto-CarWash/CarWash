...
/// catálogo, ordenados conforme o pedido do cliente) e os dados normalizados que
/// os handlers de criação/confirmação reutilizam para montar o agregado de domínio.
/// </summary>
